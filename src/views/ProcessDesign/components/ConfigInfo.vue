  ...
  <div class="config-info">
    ...
    <div>
      ...
      >
        ...
        <el-table-column label="条件表达式" align="center" width="280">
          <template slot-scope="scope">
            <div class="cell-co">
        ...
        <el-table-column label="结果表达式" align="center" width="300">
          <template slot-scope="scope">
            <div class="cell-co">
    ...
    <div>
      ...
      <div v-if="showDestination">
        ...
        >
          ...
          <el-table-column label="操作" align="center" width="60">
            <template slot-scope="scope">
              <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteDestinationRule(scope.row)"></el-button>
            </template>
          </el-table-column>
        </el-table>
        <h5>表达式</h5>
        <el-input v-model="DestinationString" type="textarea" :rows="3" placeholder="请输入内容" size="mini"></el-input>
        <div class="bar">
          <el-row>
            <el-col :span="24">
              <el-button class="filter-item btnMini" type="primary" size="mini" icon="el-icon-plus" @click="closeDestination">确认</el-button>
            </el-col>
          </el-row>
        </div>
      </div>
      <el-table v-else size="mini" border></el-table>
    </div>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      destinationTypeValue: 1, // 选人模式 默认User
      showDestination: false // 选择审批人规则 显示隐藏
    }
  },
  methods: {
    init (node) {
    ...
    refresh (type) {
      if (type === 1) {
        ...
        this.getInfo('DestinationRule', this.node) // 节点选人规则
      }
    }
  }
}
